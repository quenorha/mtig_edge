#!/bin/bash
	...
	docker run -d -p 3000:3000 --name c_grafana -e GF_PANELS_DISABLE_SANITIZE_HTML=true --net=wago --restart unless-stopped -v v_grafana:/var/lib/grafana grafana/grafana-oss
